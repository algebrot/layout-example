...
console.log(w1Eq.toString()); 
console.log(w2Eq.toString()); 
console.log(w3Eq.toString()); 
console.log(w4Eq.toString());  
console.log(w5Eq.toString());  
console.log(w6Eq.toString()); 
console.log(w7Eq.toString());  
console.log(w8Eq.toString()); 
console.log(w9Eq.toString());  
console.log(w10Eq.toString());  